<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nested GridView.aspx.cs" Inherits="Grid.Nested_GridView" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Countries">
                    <ItemTemplate>
                        <asp:GridView width="100%" ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSource='<%# Bind("Countries") %>'>
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Cities">
                                    <ItemTemplate>
                                        <asp:GridView width="100%" ID="GridView3" runat="server" DataSource='<%# Bind("Cities") %>'>
                                        </asp:GridView>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
